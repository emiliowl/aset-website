        ...
        return(<div className="container lg-padding">
            <div className="row">
                <div className="col-md-9">
                    ...
                    <p className="text-justify">
                        Após o tratamento com a mesa, também poderão ser indicados outros procedimentos como por exemplo banhos, utilização de cristais, orações, prescrição de florais, decretos, que visam sempre potencializar os efeitos do tratamento ao máximo.
                    </p>
                    <p className="text-justify">
